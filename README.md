...
2.  Abra el archivo config.js con cualquier editor de texto (como el Bloc de notas) y en la linea #1 modifique ###const topBarCenterText = `TI3GB - EJ89AU`;    por su callsing y Grilla ( Grid).
